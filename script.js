...
var projectsPage = document.querySelectorAll("#scratch-project");

projectsPage.forEach((projects, index) => {
  projects.dataset.aos = "fade-up";
  projects.dataset.aosDuration = 1500;
  projects.dataset.aosDelay = index * 300;
  // console.log(project);
  // console.log(index);
});
